...
d3.json(earthquakeData).then(function(data) {
    // Create a function to style to markers on the map.
    ...
    // Function that will determine the color of a marker based on the earthquake's magnitude
    ...
    // Function that will determine the marker's size based on magnitude.
    ...
    style: styleInfo,
    // Add a popup marker to each earthquake.
