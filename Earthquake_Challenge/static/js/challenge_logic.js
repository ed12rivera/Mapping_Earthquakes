...
let allEarthquakeData = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson"
...
d3.json(allEarthquakeData).then(function(data) {
  ...
  // Retrieve major earthquake GeoJSON data (>4.5 mag) for the week.
